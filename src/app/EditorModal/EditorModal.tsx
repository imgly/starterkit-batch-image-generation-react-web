...
import { initInstanceEditor, initTemplateEditor } from '../../imgly';
...
export function EditorModal({
  ...
  const handleInit = useCallback(
    async (cesdk: CreativeEditorSDK) => {
      ...
      const initEditor = type === 'template' ? initTemplateEditor : initInstanceEditor;
      await initEditor(cesdk, { title, onSave, onClose });
